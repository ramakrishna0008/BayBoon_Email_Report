...
public class BBEmailReport {
	@Test
	public void test1(){
		//Open chrome browser
		System.setProperty("webdriver.chrome.driver", "./drivers/chromedriver");
	//	System.setProperty("webdriver.chrome.driver", "/Users/admin/Downloads/Selenium/drivers/chromedriver");
	...
	*/	
	...
	public void test2() throws EmailException{
		...
		email.setSubject("BayBoon Daily Report!!");
	...
	public static void main(String[] args) throws EmailException{
		BBEmailReport report = new BBEmailReport();
